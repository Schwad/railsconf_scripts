...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v6.1.0.alpha/actionmailer/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v6.1.0.alpha/", "mailing_list_uri" => "https://groups.google.com/forum/#!forum/rubyonrails-talk", "source_code_uri" => "https://github.com/rails/rails/tree/v6.1.0.alpha/actionmailer" } if s.respond_to? :metadata=
